<?php
	...
	if(doesUserOwnApplication($conn, $_SESSION['broncoNetID'], $_GET['id']))
	{
		...
		/*User wants to cancel this application*/
...
<html lang="en">
	...
	<body ng-app="HIGE-app">
		...
		<div class="container-fluid">
			<form class="form-horizontal" id="approvalF" name="approvalF" method="POST" action="#">
				<div ng-controller="budget">
					...
					<?php
						if(!isset($app->status)) //if status is pending
						{
					?>
						<br><br>
						<div class="row">
							...
							<div class="col-md-4">
								...
								<input type="submit" class="styled-button-3" id="cancelA" name="cancelA" style="background-color: red !important; border-color: red !important; margin-top: 10px;" value="CANCEL APPLICATION" />
							</div>
							</center>
							<div class="col-md-4"></div>
						</div>
		...
		<?php
			...
			?>
				<h1>You are not allowed to view this application!</h1>
			<?php
			}
			?>
	</body>
