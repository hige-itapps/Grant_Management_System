...
$mysqldumpCommand = $mysqldump_path." --user=".$database_username." --password=".$database_password." --host=".$hostname." --single-transaction --no-create-info --no-create-db --skip-triggers --replace ".$database_name." administrators applicants application_approval applications applications_budgets committee emails final_report_approval final_reports notes variables > ".$backup_directory.$backup_filename;
